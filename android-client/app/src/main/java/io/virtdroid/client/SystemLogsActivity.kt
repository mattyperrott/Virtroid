...
import io.virtdroid.client.data.AppLogEntry
import io.virtdroid.client.data.AppLogFilter
import io.virtdroid.client.data.AppLogLevel
import io.virtdroid.client.data.AppLogStore
import io.virtdroid.client.databinding.ScreenSystemLogsBinding
...
class SystemLogsActivity : AppCompatActivity() {
    ...
    private fun copyLogs() {
        ...
        clipboard.setPrimaryClip(ClipData.newPlainText("Virtdroid logs", appLogs.exportText(activeFilter)))
