...
public class ScreenEncoder implements Device.RotationListener {
    ...
    public void streamScreen(Options options, Device device, OutputStream outputStream, Runnable onStreamHeaderWritten) throws IOException {
